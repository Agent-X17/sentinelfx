...
parser=argparse.ArgumentParser();parser.add_argument('command',choices=['init','sample','audit','backtest']);parser.add_argument('--db',default=str(root/'data/engine.sqlite3'));parser.add_argument('--input');args=parser.parse_args()
